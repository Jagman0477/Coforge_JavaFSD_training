...
public class SavingsAccount extends AccountUser implements User, Account {

	private float amount;
	private int time;

	public SavingsAccount(int id, String name, float salary, float amount, int time) {
	...
	public static void main(String[] args) {
		...
		SavingsAccount account=new SavingsAccount(1001, "suresh kumar",12000, 30000, 5);
